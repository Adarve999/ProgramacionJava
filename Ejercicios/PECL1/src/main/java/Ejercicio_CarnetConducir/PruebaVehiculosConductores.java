...
public class PruebaVehiculosConductores {
    ...
    public static void main(String[] args) {
        ...
        Vehiculo v3 = new Vehiculo("3456 HVF", "Audi", "A3", 100, true); //creamos los carnets de conducir 
...
//creamos los conductores con sus carnets 
        Conductor c1 = new Conductor("12345678Z", "Pepe", cc1);
        Conductor c2 = new Conductor("23456789W", "Maria", cc2);
