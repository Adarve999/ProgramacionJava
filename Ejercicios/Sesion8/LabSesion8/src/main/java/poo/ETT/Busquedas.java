...
public class Busquedas extends javax.swing.JFrame {
    ...
    List<OfertaEmpleo> busquedasAnt = new ArrayList<>();
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        try {
            ...
            List<OfertaEmpleo> busquedas = GestionOfertas.busquedaOfertas(jTextFieldCat.getText(), Double.parseDouble(jTextFieldSal.getText()));
    ...
    private void limpiarTabla(List<OfertaEmpleo> busquedas) {
